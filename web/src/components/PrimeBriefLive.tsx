...
type Decision = {
  client: {
    ...
    name: string;
    phone: string | null;
    relationshipHealth: "strong" | "normal" | "risk";
  };
  objective: string;
          ...
          <div className="rounded-2xl bg-slate-50 p-5">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {lead.client.phone ? (
                <>
                  ...
                  <a
                    href={"https://wa.me/" + phoneDigits(lead.client.phone)}
                    target="_blank"
                    rel="noreferrer"
            ...
            <div className="mt-4 rounded-2xl border bg-white p-4">
              ...
              <input
                ...
                placeholder="Örn. Yeni portföy ilgisini koruyor."
                className="mt-2 w-full rounded-xl border px-3 py-2.5 text-sm outline-none focus:border-slate-400"
              />
              <p className="mt-2 text-xs text-slate-400">Ara veya WhatsApp aksiyonu, bu sonucu da aktiviteye ekler.</p>
            </div>
            ...
            <div className="mt-4 rounded-2xl border bg-white p-4">
              ...
              <div className="mt-2 flex flex-col gap-2 sm:flex-row">
                ...
                <button
                  ...
                  onClick={() => void createTask(lead.client.id, lead.client.name, lead.nextStep)}
