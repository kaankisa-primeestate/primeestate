...
export default function PortfolioPage() {
  ...
  async function createPortfolio(event: FormEvent<HTMLFormElement>) {
    ...
    const detailKeys = ["buildingAge","heating","bathrooms","furnished","balcony","parking","landSize","pool","garden","zoning","parcel","island","kaks","taks","roadFrontage","commercialType","floorCount","totalFloors","units","period","season","siteName","term"];
...
<label><span className="mb-1.5 block text-xs font-semibold text-slate-600">Bina yaşı *</span><input name="buildingAge" required type="number" min="0" className="w-full rounded-xl border border-slate-200 px-3 py-3 text-sm"/></label>
<label><span className="mb-1.5 block text-xs font-semibold text-slate-600">Isıtma *</span><select name="heating" required defaultValue="" className="w-full rounded-xl border border-slate-200 px-3 py-3 text-sm"><option value="">Seçiniz</option><option>Doğalgaz</option><option>Merkezi</option><option>Yerden ısıtma</option><option>Klima</option><option>Diğer</option></select></label>
...
<label><span className="mb-1.5 block text-xs font-semibold text-slate-600">Balkon</span><select name="balcony" defaultValue="Yok" className="w-full rounded-xl border border-slate-200 px-3 py-3 text-sm"><option>Yok</option><option>Var</option></select></label>
<label><span className="mb-1.5 block text-xs font-semibold text-slate-600">Otopark</span><select name="parking" defaultValue="Yok" className="w-full rounded-xl border border-slate-200 px-3 py-3 text-sm"><option>Yok</option><option>Açık</option><option>Kapalı</option></select></label>
</> : null}
